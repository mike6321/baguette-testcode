 ...
 */
@Service
public class AuthorityCheckGeneralCustomerService {

    AuthorityCheckRepository authorityCheckRepository;

    public AuthorityCheckGeneralCustomerService(@Qualifier("autorityCheckGeneralCustomerRepositoryImpl") final AuthorityCheckRepository authorityCheckRepository) {
